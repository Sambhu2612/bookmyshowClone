    ...
    return(
        <Router>
            <header>
                    ...
                    <div className="header_1">
                        <div>
                            ...
                            <div className="Search_Box">
                                ...
                                <div>Search for Movies, Events, Plays, Sports and Activities</div>
                            </div>
                        </div>
                        <div>
                            <div className="nav_location_txt_container">
                                <span className="nav_location_txt">Cuttack</span>
                            </div>
                            <div className="sign_in_button">
                                <span>Sign in</span>
                            </div>
                            <div className="sliding_nav_bar">
                ...
                <div className="header_2_container">
                    <div className="header_2">
                        <div>
                            <Switch>
                                <Route exact path="/">
                                    <a href="/Movies">Movies</a>
                                    <a href="/Stream">Stream<div>NEW</div></a>
                                    <a>Events</a>
                                    <a>Plays</a>
                                    <a>Sports</a>
                                    <a>Activities</a>
                                ...
                                <Route exact path="/Stream">
                                    <a href="/Movies">Movies</a>
                                    <a href="/Stream" style={{color: "rgb(220, 53, 88)"}}>Stream<div>NEW</div></a>
                                    <a>Events</a>
                                    <a>Plays</a>
                                    <a>Sports</a>
                                    <a>Activities</a>
                                ...
                                <Route exact path="/Movies">
                                    <a href="/Movies" style={{color: "rgb(220, 53, 88)"}}>Movies</a>
                                    <a href="/Stream">Stream<div>NEW</div></a>
                                    <a>Events</a>
                                    <a>Plays</a>
                                    <a>Sports</a>
